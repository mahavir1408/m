$(document).ready(function(){
	...
	var save = function(itemJson){
		$.ajax({
			data: {items:JSON.stringify(itemJson)},
			url: "/invoice/save",
			method:'post',
	...
	var constructInvoicePage = function(){
		$("#save").on("click",function(){alert("tt");generatePrint();return false;});
		$("#invoice").html(html);
		...
		$("#save").on("click",function(){generatePrint();});
