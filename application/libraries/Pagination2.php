<?php  defined('BASEPATH') OR exit('No direct script access allowed');
     ...
     * @author              ExpressionEngine Dev Team
     * @link                http://codeigniter.com/user_guide/libraries/pagination2.html
     */
    ...
    http://codeigniter.com/forums/viewthread/197457/
    copy this file to application\libraries folder
    ...
    class Pagination2 {
            ...
            public function __construct($params = array())
            {
                    ...
                    log_message('debug', "Pagination2 Class Initialized");
            }
            ...
            /**
             * Generate the pagination2 links
             *
             * @access      public
             * @return      string
             */
    ...
    //              $this->cur_page = floor(($this->cur_page/$this->per_page) + 1);
                    ...
                    // Is pagination2 being used over GET or POST?  If get, add a per_page query
    ...
    /* End of file Pagination2.php */
    /* Location: ./system/libraries/Pagination2.php */